...
public class RunDemo
{
	public static void main(String[] args)
	{
		...
		final double speciesCutoffDelta = 0.1;
		final double mutationWeightProb = 0.4;
		final double mutationAddLinkProb = 0.1;
		final double mutationAddNodeProb = 0.1;
		final double mutationWeightRange = 0.5;
		...
		final EvolutionMonitor<NEATGenome> monitor = new EvolutionMonitor<NEATGenome>(new Renderer<NEATGenome, JComponent>()
		{
			@Override
			public JComponent render(NEATGenome entity)
			{
				JTextArea text = new JTextArea("Doesn't work yet.");
