...
public final class RunDemo {
    ...
    public static class NESFitness implements FitnessEvaluator<NEATGenome> {
        private final ThreadLocal<NES> nes = new ThreadLocal<>();
        private final ThreadLocal<HeadlessUI> ui = new ThreadLocal<>();
